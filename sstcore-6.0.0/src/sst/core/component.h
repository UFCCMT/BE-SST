...
//    typedef Params Params_t;
    ...
    */
    ...
    static std::map<std::tuple<std::string, std::vector<float>>, std::vector<double>> getGlobalLookupCache();
    /** Update the global cache that stores lookup values in Behavioral Emulation*/
    static void updateGlobalLookupCache(std::map<std::tuple<std::string, std::vector<float>>, std::vector<double>> cache);
