...
public:
    ...
    /** Return the global cache that stores lookup values in Behavioral Emulation*/
    std::map<std::tuple<std::string, std::vector<float>>, std::vector<double>> getGlobalLookupCache();
    /** Update the global cache that stores lookup values in Behavioral Emulation*/
    void updateGlobalLookupCache(std::map<std::tuple<std::string, std::vector<float>>, std::vector<double>> cache);
...
private:
    ...
    std::map<std::tuple<std::string, std::vector<float>>, std::vector<double>> globalLookupCache;
