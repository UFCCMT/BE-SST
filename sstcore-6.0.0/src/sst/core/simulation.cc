...
Simulation::getGlobalLookupCache()
{
    return globalLookupCache;
}

void 
Simulation::updateGlobalLookupCache(std::map<std::tuple<std::string, std::vector<float>>, std::vector<double>> cache)
{
    globalLookupCache = cache;
}
