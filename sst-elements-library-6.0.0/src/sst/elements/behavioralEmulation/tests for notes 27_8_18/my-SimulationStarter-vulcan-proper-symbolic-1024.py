...
# Define SST core options
  #Is this the minimum timestep?
sst.setProgramOption("timebase", "1 ps")
#sst.setProgramOption("stopAtCycle", "25us")

# Obtain the simulation flags
  #These will be given over from BE_RUN.sh
system_config = "vulcan-proper-symbolic-1024.py"
output_file = ""
interpolation = ""
debug = ""
eventtrace = ""
...
#Create a simulator with the given configuration
  #Just inits a buch of lists/dictionaries and passes file name in sys_config var
sim = Simulator(system_config)

sim.build()

#Just transfering variable from the sim object to the current file (better way?)
  #Need to know all of these objects?
