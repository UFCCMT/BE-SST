...
#Offspring( "system", Torus( "BGQ-core", "BGQ-network", [2, 4, 8] ) )
#print("ddf")
Offspring( "system", Tree( ["BGQ-connection-Root", "BGQ-connection-2", "BGQ-connection-1", "BGQ-core"], ["BGQ-network-Root","BGQ-network-2", "BGQ-network-1"], [2,4,8] ) )
Root("system")
