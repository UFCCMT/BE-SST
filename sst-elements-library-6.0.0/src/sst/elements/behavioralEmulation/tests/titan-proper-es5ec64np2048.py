...
cartesianData = CartesianGrid(4, 4, 4)

Component( "Titan-core" )
Program( "Titan-core", "cmt-bone-be.txt" )

Property( "Titan-core", "app.elementSize", lambda gid, cid, cids, index: 5 )
Property( "Titan-core", "app.elementsPerProcess", lambda gid, cid, cids, index: 64 )
Property( "Titan-core", "app.transferSizeX", lambda gid, cid, cids, index: 16000 )
Property( "Titan-core", "app.transferSizeY", lambda gid, cid, cids, index: 16000 )
Property( "Titan-core", "app.transferSizeZ", lambda gid, cid, cids, index: 16000 )
Property( "Titan-core", "app.timesteps", lambda gid, cid, cids, index: 100 )
...
Operation( "Titan-network", "transfer", "titan-transfer-inter-bw.csv", "linear",
             Dawdle( AnyOutput() ))
Mailbox( "Titan-network", "transfer", lambda source, target, size, tag: [size],
           OnAll )

#Component("Titan-node")
#Attribute("Titan-node", "usage", 0.0)
Component("Titan-node")

Component( "node" )
Offspring( "node", Torus( "Titan-node", "Titan-network", [ 4, 2, 2 ] ) )
Component( "system" )
Offspring( "system", Torus( "node", "Titan-network", [ 4, 4, 4 ] ) )
Root("system")
